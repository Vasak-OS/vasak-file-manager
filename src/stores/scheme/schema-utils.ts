...
export async function migrateStorageSchema(params: {
	...
	const { storage, schemaVersionKey, latestSchemaVersion, migrateStep } = params;
	...
	const shouldPersistSchemaVersion =
		didMigrate || normalizedStoredSchemaVersion !== latestSchemaVersion;
